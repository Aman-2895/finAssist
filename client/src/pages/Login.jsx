...
// Shared Clerk appearance so <SignIn> and <SignUp> look like part of
// FinAssist rather than a generic auth widget. Values are literal hex
// (not CSS var() references) since Clerk's styling layer doesn't reliably
// resolve custom properties from the host page.
    ...
    <div className="min-h-screen grid lg:grid-cols-2" style={{ background: 'var(--bg)' }}>
      ...
      >
        ...
        <div className="relative">
          ...
          >
            Financial tools built for how gig work actually pays.
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            No CIBIL history? No fixed salary slip? FinAssist scores you from what you actually
            earn and spend — and helps you save, invest, and plan around it.
          </motion.p>
        </div>
